...
public class TerminalAutoservicio {
    ...
    // Paleta accesible (daltonismo rojo-verde). Solo color, no toca tamanos ni pesos.
    private static final Color VERDE = new Color(0, 107, 63);
    private static final Color PLACEHOLDER = new Color(107, 107, 107);
    ...
    private void initialize() {
        ...
        lblIngrese.setFont(new Font("SansSerif", Font.PLAIN, 18));
        ...
        agregarPlaceholder(txtDNI, "Ej: 12345678");
        panelInput.add(txtDNI);

        btnEnviar = new JButton("REGISTRARSE");
