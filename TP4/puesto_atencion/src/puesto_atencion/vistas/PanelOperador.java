...
public class PanelOperador {
    ...
    private static final Color VERDE = new Color(0, 107, 63);
    private static final Color CYAN = new Color(0, 109, 119);
    private static final Color ROJO = new Color(176, 0, 32);
    private static final Color GRIS = new Color(217, 217, 217);
    private static final Font FONT_FILA_DESTACADA = new Font("SansSerif", Font.BOLD, 16);
    private static final Font FONT_FILA_NORMAL = new Font("SansSerif", Font.PLAIN, 16);
    ...
    private void initialize() {
        ...
        lblTituloPuesto.setFont(new Font("SansSerif", Font.BOLD, 26));
        ...
        lblClientesEnEspera.setFont(new Font("SansSerif", Font.BOLD, 22));
        ...
        lblClienteActual.setFont(new Font("SansSerif", Font.BOLD, 22));
        ...
        lblHistorial.setFont(new Font("SansSerif", Font.BOLD, 16));
        ...
        scroll.setBorder(BorderFactory.createLineBorder(new Color(138, 138, 138)));
    ...
    private void configurarTablaHistorial(JTable tabla) {
        ...
        tabla.setForeground(new Color(107, 107, 107));
        ...
        DefaultTableCellRenderer renderer = new DefaultTableCellRenderer() {
            ...
            public java.awt.Component getTableCellRendererComponent(JTable table, Object value,
                ...
                c.setForeground(new Color(107, 107, 107));
    ...
    public void setEstadoBotones(EstadoBotones estado) {
        ...
        switch (estado) {
            ...
            case CON_CLIENTE_PUEDE_RELLAMAR:
                ...
                btnRellamar.setBackground(CYAN);
                btnRellamar.setText("Rellamar");
                btnEliminar.setEnabled(false);
                btnEliminar.setBackground(GRIS);
                break;
