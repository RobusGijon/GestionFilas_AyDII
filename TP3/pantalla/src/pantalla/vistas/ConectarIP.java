...
public class ConectarIP {
    ...
    private void initialize() {
        ...
        lblIPSec.setFont(new Font("Tahoma", Font.PLAIN, 18));
        lblIPSec.setBackground(Color.WHITE);
        filaSec.add(lblIPSec);

        textFieldIPSec = new JTextField();
        textFieldIPSec.setFont(new Font("Tahoma", Font.PLAIN, 14));
        ...
        lblPuertoSec.setFont(new Font("Tahoma", Font.PLAIN, 18));
        lblPuertoSec.setBackground(Color.WHITE);
        filaSec.add(lblPuertoSec);

        textFieldPuertoSec = new JTextField();
        textFieldPuertoSec.setFont(new Font("Tahoma", Font.PLAIN, 14));
