...
public class ConectarIP {
    ...
    private void initialize() {
        ...
        lblIPSec.setFont(new Font("Tahoma", Font.PLAIN, 16));
        filaSecundario.add(lblIPSec);

        textFieldIPSecundario = new JTextField();
        textFieldIPSecundario.setFont(new Font("Tahoma", Font.PLAIN, 14));
        ...
        lblPuertoSec.setFont(new Font("Tahoma", Font.PLAIN, 16));
        filaSecundario.add(lblPuertoSec);

        textFieldPuertoSecundario = new JTextField();
        textFieldPuertoSecundario.setFont(new Font("Tahoma", Font.PLAIN, 14));
