...
public class LoggerServidor implements ILogger {
    ...
    private volatile Supplier<RolNodo> proveedorRol = () -> null;

    @Override
    public void setProveedorRol(Supplier<RolNodo> proveedor) {
        this.proveedorRol = (proveedor != null) ? proveedor : () -> null;
    }

    private String ts() {
        RolNodo r = proveedorRol.get();
        String tag = (r == null) ? "STANDALONE"
                   : (r == RolNodo.PRIMARIO ? "PRI" : "SEC");
